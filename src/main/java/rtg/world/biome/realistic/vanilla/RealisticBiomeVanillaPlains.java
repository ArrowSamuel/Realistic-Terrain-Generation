...
public class RealisticBiomeVanillaPlains extends RealisticBiomeVanillaBase {
    ...
    public void initConfig() {
        ...
        this.getConfig().addProperty(this.getConfig().WHEAT_MIN_Y).set(RTGAPI.config().SEA_LVL_MODIFIER.get());
    ...
    public class TerrainVanillaPlains extends TerrainBase {
        ...
        public float generateNoise(IRTGWorld rtgWorld, int x, int y, float border, float river) {
            ...
            return riverized((RTGAPI.config().SEA_LVL_MODIFIER.get()+ 3f) + groundEffect.added(rtgWorld, x, y), river);
        }
    }
    ...
    public void initDecos() {
        ...
        decoShrubOak.setMaxY((RTGAPI.config().SEA_LVL_MODIFIER.get()) + 47);
        ...
        decoFlowersRTG.setMaxY((RTGAPI.config().SEA_LVL_MODIFIER.get()) + 65);
        decoFlowersRTG.setStrengthFactor(2f);
        this.addDeco(decoFlowersRTG);

        // Lots of grass, but not as much as vanilla.
        DecoGrass decoGrass = new DecoGrass();
        decoGrass.setMinY((RTGAPI.config().SEA_LVL_MODIFIER.get()) + 3);
